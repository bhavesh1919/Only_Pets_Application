...
import 'package:only_pets/login%20api/api.dart';
import 'package:only_pets/HomePage/homepage.dart' as models;
import 'package:only_pets/product_api.dart';
...
class _ProductScreenState extends State<ProductScreen> {
  ...
  void initState() {
    super.initState();
    productsList = ProductAPI.fetchProducts(); // API call here
  }
